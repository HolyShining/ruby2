...
class DeliversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deliver" do
    assert_difference('Deliver.count') do
      post delivers_url, params: { deliver: { address: @deliver.address, delivers: @deliver.delivers, name: @deliver.name, objectlist: @deliver.objectlist } }
    end
  ...
  test "should update deliver" do
    patch deliver_url(@deliver), params: { deliver: { address: @deliver.address, delivers: @deliver.delivers, name: @deliver.name, objectlist: @deliver.objectlist } }
